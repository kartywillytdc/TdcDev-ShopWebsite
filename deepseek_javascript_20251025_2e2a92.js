...
function updateUI() {
    ...
    const publicUserMenu = document.getElementById('publicUserMenu');
    const publicUserEmail = document.getElementById('publicUserEmail');
    const adminAvatar = document.getElementById('adminAvatar');

    if (currentUser) {
        // Usuário logado
        publicAuthButtons.style.display = 'none';
        publicUserMenu.style.display = 'flex';
        publicUserEmail.textContent = currentUser.email;
        ...
        adminPanel.style.display = 'none';
        publicWebsite.style.display = 'block';
        publicAuthButtons.style.display = 'flex';
        publicUserMenu.style.display = 'none';
    }
}
